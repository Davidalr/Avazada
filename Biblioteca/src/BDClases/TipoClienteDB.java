...
public class TipoClienteDB extends DBManager {

    public static TipoClienteDB mgr = new TipoClienteDB();

    private TipoClienteDB() {
    }
    ...
    public List<HashMap<String, Object>>  allItem() {
        ...
        return executeQuery("select * from \"tipo_clientes\" ");
    }
